...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        watch: {
            ...
            /*
             * recess: { files: {'dist/main.css': ['<%= yeoman.app
             * %>/styles/main.less']}, tasks: ['recess'] },
             */
            livereload: {
                options: {
        ...
        /*
         * recess: { dist: { options: { compile: true } }, server: {
         *
         * options: { debugInfo: true }, files: { 'dist/main.css': ['<%=
        ...
        cssmin: {
            ...
            // care of
            // minification. This option is pre-configured if you do not
            // wish to use
            // Usemin blocks.
            // dist: {
            // files: {
        ...
        'ftp-deploy': {
            build: {
                ...
                src: '<%= yeoman.dist %>',
                dest: 'www/v4',
                exclusions: ['**/.DS_Store', '**/Thumbs.db', '<%= yeoman.dist %>/tmp', '<%= yeoman.dist %>/bower_components', '.htaccess']
            }
        }
    });
    ...
    grunt.registerTask('default', ['jshint', 'test', 'build', 'ftp-deploy']);
};